 ...
 * 2020-09-27T23:12:07.978+02:00
 * Generated source version: 3.3.7
 *
 */
@WebServiceClient(name = "BookService",
                  wsdlLocation = "file:/home/user/ws/idea/about-java/webservice/src/main/resources/wsdl/Tutorial.wsdl",
...
public class BookService_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/home/user/ws/idea/about-java/webservice/src/main/resources/wsdl/Tutorial.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(BookService_Service.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/home/user/ws/idea/about-java/webservice/src/main/resources/wsdl/Tutorial.wsdl");
        }
        WSDL_LOCATION = url;
    }
