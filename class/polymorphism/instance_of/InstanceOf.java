package polymorphism.instance_of;
...
public class InstanceOf {
    ...
    void test(){
        ...
        boolean b;
        b = new Child3() instanceof Parent;  // true
        b = new Parent() instanceof Child3; // false // parent cant be cast to child without explicit cast
...
class Child3 extends Parent implements Child3Interface {
